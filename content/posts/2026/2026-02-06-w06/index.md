...
I've been [hiding little printed critters](https://masto.hackers.town/@lmorchard/115997933734139566) around the house lately. Out of reach of cats, but my wife likes finding them:
...
Stupid shower thought: Remember that guy who [spent $20](https://masto.hackers.town/@lmorchard/116019712986994364) using an LLM as an alarm clock that just repeatedly asked "is it time yet?" all night until the tokens ran out?
...
* My wife [bought a bag](https://masto.hackers.town/@lmorchard/116002538420952067) of like 50 small soft mice cat toys and dumped them all out in the living room. Miss Biscuits spent all night gradually distributing them throughout the house. I just threw three down the hall and I think it blew her mind trying to figure out which one to chase. This is peak cat content, folks.

* [*Friendship Skills for Neurodivergent Adults*](https://www.hachettebookgroup.com/titles/caroline-maguire/friendship-skills-for-neurodivergent-adults/9781538773086/) - book providing practical strategies for neurodivergent adults with ADHD, autism, or anxiety

* [*Defeating a 40-year-old copy protection dongle*](https://dmitrybrant.com/2026/02/01/defeating-a-40-year-old-copy-protection-dongle) - helping an accounting firm escape legacy software locked behind ancient hardware

* [*Decentralizing My Smartphone With Single Purpose Devices*](https://ambertherambler.bearblog.dev/decentralizing-my-smartphone-with-single-purpose-devices/) - replacing the everything-device with focused single-purpose gadgets

* [*Turns Out They Didn't Really Want You To Bring Your Whole Self To Work*](https://www.techdirt.com/2026/02/03/turns-out-they-didnt-really-want-you-to-bring-your-whole-self-to-work/) - whole self was just the price of admission in a seller's market; now it's a buyer's market

* [*No. You can't tell it was written by AI*](https://segunfamisa.com/posts/no-you-cant-tell-it-was-written-by-ai#fn:5) and [*I'm Kenyan. I Don't Write Like ChatGPT*](https://marcusolang.substack.com/p/im-kenyan-i-dont-write-like-chatgpt) - important pieces about how AI detectors flag non-native English speakers

* [*My AI Adoption Journey*](https://mitchellh.com/writing/my-ai-adoption-journey) - Mitchell Hashimoto's nuanced, measured approach to finding value in AI tooling

* [*Speedrunning Agentic Software Engineering Management*](https://blog.fsck.com/2026/02/03/managing-agents/) - we're speed-running through software engineering history; agentic methodologies are somewhere around the 1970s

* [*Programming is Dead*](https://hamptonmakes.com/blog/2026/02/06/programming-is-dead.html) - the loom metaphor: this is the worst these tools will ever be
...
* [*Latent Space Engineering*](https://blog.fsck.com/2026/01/30/Latent-Space-Engineering/) - actively managing agents' vibes and feelings, treating them as having mental states rather than just token prediction engines

* [*Server-Sent Events Beat WebSockets*](https://dev.to/polliog/server-sent-events-beat-websockets-for-95-of-real-time-apps-heres-why-a4l?context=digest) for 95% of real-time apps because bidirectional comes with a complexity tax

* [*maptoposter*](https://github.com/originalankur/maptoposter) - transform cities into beautiful minimalist map posters with code
