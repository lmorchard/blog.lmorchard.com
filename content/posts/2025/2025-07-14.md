...
I think this is the core good advice - and also why I think this stuff works pretty well for greenfield explorations, too: Do you need to get in and do something quickly? Prove out a concept before investing more time?  Want to grind through some backlog tedium? In these cases, an LLM-powered coding assistant can work like a power tool, mechanically ghrinding through what 

But, if you need to do some big thinking about architecture, tricky requirements, and fussy constraints - that's a job for human brains. LLMs can advise by surfacing what other folks have written about conventions and best practices in the past - but you'll need to verify all of that for yourself anyway. 
