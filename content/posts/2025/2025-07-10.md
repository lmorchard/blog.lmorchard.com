...
I'd like not to just offer a knee-jerk kool-aid drinker's reaction. A few interesting things from reading the article:
...
That's a rather small sample, isn't it? And a rather specific scenario? I think a difference for my anecdotal situation is that I've been engaged in a lot of new work, lately. Greenfield projects or relatively young projects. Decidedly *not* projects with over 1.1m lines of code. Maybe that's something?

> We do not claim that our developers or repositories represent a majority or plurality of software development work

This seems like something that could be stated more emphatically? Folks will do what they do when seeing headlines like this, but 
