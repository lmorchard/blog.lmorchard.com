import"./chunk-ACQIU22U.js";import{c as ae,k as R}from"./chunk-3ITOJMSU.js";import"./chunk-ZAYPLI4D.js";import"./chunk-UB6KUSLE.js";import"./chunk-VPTMNO6G.js";import{a as s,c as b,f as D}from"./chunk-BQSSZJ55.js";import{D as _,E as a,I as F,M as T,_ as l,a as u,aa as f,b as h,h as y,j as c}from"./chunk-XC7EGGVM.js";import{c as me}from"./chunk-I75INDCH.js";var w={extension:{type:u.Environment,name:"browser",priority:-1},test:()=>!0,load:async()=>{await import("./browserAll-P4OPW7ZO.js")}};var I={extension:{type:u.Environment,name:"webworker",priority:0},test:()=>typeof self<"u"&&self.WorkerGlobalScope!==void 0,load:async()=>{await import("./webworkerAll-I2U7UIIL.js")}};var P;function L(t){return P!==void 0||(P=(()=>{let e={stencil:!0,failIfMajorPerformanceCaveat:t??b.defaultOptions.failIfMajorPerformanceCaveat};try{if(!T.get().getWebGLRenderingContext())return!1;let o=T.get().createCanvas().getContext("webgl",e),p=!!o?.getContextAttributes()?.stencil;if(o){let i=o.getExtension("WEBGL_lose_context");i&&i.loseContext()}return o=null,p}catch{return!1}})()),P}var B;async function z(t={}){return B!==void 0||(B=await(async()=>{let e=T.get().getNavigator().gpu;if(!e)return!1;try{return await(await e.requestAdapter(t)).requestDevice(),!0}catch{return!1}})()),B}var k=["webgl","webgpu","canvas"];async function V(t){let e=[];t.preference?(e.push(t.preference),k.forEach(i=>{i!==t.preference&&e.push(i)})):e=k.slice();let r,o={};for(let i=0;i<e.length;i++){let n=e[i];if(n==="webgpu"&&await z()){let{WebGPURenderer:m}=await import("./WebGPURenderer-MYQWRHV2.js");r=m,o={...t,...t.webgpu};break}else if(n==="webgl"&&L(t.failIfMajorPerformanceCaveat??b.defaultOptions.failIfMajorPerformanceCaveat)){let{WebGLRenderer:m}=await import("./WebGLRenderer-SQJAZXRM.js");r=m,o={...t,...t.webgl};break}else if(n==="canvas")throw o={...t},new Error("CanvasRenderer is not yet implemented")}if(delete o.webgpu,delete o.webgl,!r)throw new Error("No available renderer for the current environment");let p=new r;return await p.init(o),p}var W=class O{constructor(...e){this.stage=new F,e[0]!==void 0&&c(y,"Application constructor options are deprecated, please use Application.init() instead.")}async init(e){e={...e},this.renderer=await V(e),O._plugins.forEach(r=>{r.init.call(this,e)})}render(){this.renderer.render({container:this.stage})}get canvas(){return this.renderer.canvas}get view(){return c(y,"Application.view is deprecated, please use Application.canvas instead."),this.renderer.canvas}get screen(){return this.renderer.screen}destroy(e=!1,r=!1){let o=O._plugins.slice(0);o.reverse(),o.forEach(p=>{p.destroy.call(this)}),this.stage.destroy(r),this.stage=null,this.renderer.destroy(e),this.renderer=null}};W._plugins=[];var A=W;h.handleByList(u.Application,A._plugins);h.add(D);var le=me(ae(),1);h.add(w,I);var d=`in vec2 aPosition;
