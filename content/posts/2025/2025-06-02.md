...
- I was having an argument with someone, trying to convince them that LLMs aren't just a vaporware scam incapable of real work.
	...
	- Like, not that the results should be considered illegitimate, but that the results are literally not possible or real.
	- I couldn't quite convince them that their reasoning was tangled up. It can both be true that the origin of a thing is illegitimate and yet the results of that thing are real.
	- If someone stole the material to build an atom bomb - and successfully built it - they have a functioning atom bomb.
	- 
