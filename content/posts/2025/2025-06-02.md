...
- I was having an argument with someone, trying to convince them that LLMs aren't just a vaporware scam incapable of real work.
	...
	- And in that kind of situation, the next priority should to figure out what to do about the bomb. Fretting about the theft should really only figure into dealing with future bombs - that doesn't retroactively dismantle the one that exists now.
	- 
