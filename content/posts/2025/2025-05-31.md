...
This blog has a "backend" build process to build the static HTML from all the Markdown content source files. But, the frontend is pretty much all build-free. 