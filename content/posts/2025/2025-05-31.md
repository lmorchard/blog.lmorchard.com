...
In that file, I accumulate notions and tasks over the course of a day. Occasionally, something buds off into a linked page devoted to the topic - a project, a person, a train of thought. Sometimes I use tags to index notions on theme I might want to collect later.

I've been doing this for about six years, so far. I think it's become a pretty good system. I don't use many of the fancier features of Obsidian, though there are a few things I do by hand for which I keep meaning to write a plugin or some scripts.